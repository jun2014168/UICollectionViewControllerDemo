...
@interface QJPhotoCircleController ()<UICollectionViewDataSource, UICollectionViewDelegate>
@property (nonatomic, strong) NSMutableArray *images;
@property (nonatomic, weak) UICollectionView *collectionView;

@end

@implementation QJPhotoCircleController
...
- (void)viewDidLoad {
    ...
    CGRect rect = CGRectMake(0, 100, w, 250);
    UICollectionView *collectionView = [[UICollectionView alloc] initWithFrame:rect collectionViewLayout:[[QJPhotoCircleLayout alloc] init]];
...
{
    if ([self.collectionView.collectionViewLayout isKindOfClass:[QJPhotoCircleLayout class]]) {
        [self.collectionView setCollectionViewLayout:[[QJPhotoLineLayout alloc] init] animated:YES];
    } else {
        [self.collectionView setCollectionViewLayout:[[QJPhotoCircleLayout alloc] init] animated:YES];
    }
}
