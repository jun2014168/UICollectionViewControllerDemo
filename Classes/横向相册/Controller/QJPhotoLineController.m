...
@interface QJPhotoLineController ()<UICollectionViewDataSource, UICollectionViewDelegate>
...
@implementation QJPhotoLineController
...
- (void)viewDidLoad {
    ...
    UICollectionView *collectionView = [[UICollectionView alloc] initWithFrame:rect collectionViewLayout:[[QJPhotoLineLayout alloc] init]];
...
#pragma mark - 点击屏幕切换效果
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
    if ([self.collectionView.collectionViewLayout isKindOfClass:[QJPhotoLineLayout class]]) {
