...
static const CGFloat QJItemWH = 100;

@implementation QJPhotoLineLayout
- (instancetype)init
{
    if (self = [super init]) {
    }
...
- (void)prepareLayout
{
    ...
    // 每个cell的尺寸
    self.itemSize = CGSizeMake(QJItemWH, QJItemWH);
    CGFloat inset = (self.collectionView.frame.size.width - QJItemWH) * 0.5;
    self.sectionInset = UIEdgeInsetsMake(0, inset, 0, inset);
    // 设置水平滚动
    self.scrollDirection = UICollectionViewScrollDirectionHorizontal;
    self.minimumLineSpacing = QJItemWH * 0.7;
